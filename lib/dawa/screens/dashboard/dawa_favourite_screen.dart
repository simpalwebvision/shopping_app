...
class DawaFavouriteScreen extends StatefulWidget {
  const DawaFavouriteScreen({super.key});

  @override
  State<DawaFavouriteScreen> createState() => _LikesScreenState();
}

class _LikesScreenState extends State<DawaFavouriteScreen> {
  @override
  Widget build(BuildContext context) {
    final DawaFavoriteProvider provider = DawaFavoriteProvider.of(context);
    final List<GroceryItem> favoriteList = provider.favoriteList;
            ...
            children: [
              favoriteList.isEmpty
                  ? buildNoFavoriteItem(
                      ...
                      subtitle:
                          "Grocery added to your favorites will be shown here",
                    )
                  : Expanded(
